...
| --- | --- |
| ![reCamera Pro product and accessories](images/product-kit.png) | ![reCamera Pro physical dimensions](images/product-dimensions.png) |

### Interface overview

![reCamera Pro hardware interface](images/hardware-interface.png)

### Front and side

| Front | Side |
| --- | --- |
| ![Front view](images/front-view.png) | ![Side view](images/side-view.png) |

### Expansion connector and debug UART

| Expansion connector | Debug UART |
| --- | --- |
| ![Expansion connector](images/expansion-connector.jpg) | ![Debug UART](images/debug-uart.jpg) |
